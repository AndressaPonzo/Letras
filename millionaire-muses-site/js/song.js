...
const PT_WORDS = /\b(que|não|nao|é|para|com|se|sua|seu|suas|seus|minha|meu|minhas|meus|está|esta|estão|estao|isso|esse|essa|isto|cada|dia|dias|mais|muito|muita|nunca|sempre|quero|voce|você|sou|estou|sinto|digo|fico|ficando|vida|nós|nos|eu|ele|ela|eles|elas|nao|não|de|do|da|dos|das|em|no|na|nos|nas|um|uma|uns|umas|mas|também|tambem|ainda|já|ja|aqui|ali|lá|la|onde|quando|como|porque|porquê|assim|então|entao|pois|todo|toda|todos|todas|tudo|nada|coisa|coisas|amor|coração|coracao|sempre|jamais)\b/i;

const EN_WORDS = /\b(the|and|my|is|am|are|was|were|will|would|its|dont|do|does|did|i|you|your|yours|that|this|these|those|every|to|in|of|a|an|with|for|on|at|but|or|so|just|like|know|got|get|getting|going|gonna|wanna|all|we|us|our|they|them|their|he|she|him|her|his|what|when|where|why|how|not|no|yes|can|could|should|must|have|has|had|been|be|being|into|from|out|up|down|over|under|me|it|as|if|than|then|there|here|now|never|always|love|heart|feel|feeling|say|said|way|day|life|time|world)\b/i;
