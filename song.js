...
const PT_WORDS = /\b(que|não|nao|é|para|com|se|sua|seu|suas|seus|minha|meu|minhas|meus|está|esta|estão|estao|isso|esse|essa|isto|cada|dia|dias|mais|muito|muita|nunca|sempre|quero|voce|você|sou|estou|sinto|digo|fico|ficando|vida|nós|nos|eu|ele|ela|eles|elas|o|os|de|do|da|dos|das|em|no|na|nos|nas|um|uma|uns|umas|mas|também|tambem|ainda|já|ja|aqui|ali|lá|la|onde|quando|como|porque|porquê|assim|então|entao|pois|todo|toda|todos|todas|tudo|nada|coisa|coisas|amor|coração|coracao|jamais)\b/i;
